    ...
    <div class="sidebar" 
        ...
        <div class="sidebar-menu">
            @if(Auth::user()->rolSistema->nombre === 'admin')
                ...
                <a href="{{ route('admin.proyectos-evaluaciones.index') }}" class="menu-item {{ request()->routeIs('admin.proyectos-evaluaciones.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.jurado-tokens.index') }}" class="menu-item {{ request()->routeIs('admin.jurado-tokens.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @elseif(Auth::user()->rolSistema->nombre === 'estudiante')
                ...
                <a href="{{ route('estudiante.proyectos.index') }}" class="menu-item {{ request()->routeIs('estudiante.proyectos.*') || request()->routeIs('estudiante.proyecto.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Mis Proyectos
