    ...
    <div class="border-outer">
        <div class="border-inner">
            ...
            <div class="text-center">
                ...
                <div class="otorga-text">OTORGA LA PRESENTE</div>
                
                <div class="diploma-title">CONSTANCIA</div>
                ...
                <div class="body-text">
                    POR SU VALIOSA PARTICIPACIÓN COMO <b>JURADO CALIFICADOR</b> EN EL EVENTO <b>{{ $evento->nombre }}</b>,
                    APORTANDO SU EXPERIENCIA EN "{{ $jurado->empresa_institucion }}" Y ESPECIALIDAD EN <b>{{ $jurado->especialidad }}</b>.
                </div>
