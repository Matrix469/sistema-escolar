                    ...
                    <form action="{{ route('admin.eventos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre" id="nombre" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('nombre') }}" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="cupo_max_equipos" id="cupo_max_equipos" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('cupo_max_equipos') }}" required min="1">
                            </div>

                            <!-- Fecha de Inicio -->
                            <div>
                                <label for="fecha_inicio" class="block font-medium text-sm text-gray-700">Fecha de Inicio</label>
                                <input type="date" name="fecha_inicio" id="fecha_inicio" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('fecha_inicio') }}" required>
                            </div>

                            <!-- Fecha de Fin -->
                            <div>
                                <label for="fecha_fin" class="block font-medium text-sm text-gray-700">Fecha de Fin</label>
                                <input type="date" name="fecha_fin" id="fecha_fin" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('fecha_fin') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('descripcion') }}</textarea>
                        </div>

                        <!-- Imagen del Evento -->
                        <div class="mt-6">
                            <label for="ruta_imagen" class="block font-medium text-sm text-gray-700">Imagen del Evento</label>
