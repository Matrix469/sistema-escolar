            ...
            <form action="{{ route('admin.eventos.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" class="neuro-input" value="{{ old('nombre') }}" required>
                    </div>

                    <!-- Cupo Máximo de Equipos -->
                    <div>
                        <label for="cupo_max_equipos" class="form-label">Cupo Máximo de Equipos</label>
                        <input type="number" name="cupo_max_equipos" id="cupo_max_equipos" class="neuro-input" value="{{ old('cupo_max_equipos') }}" required min="1">
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="4" class="neuro-textarea">{{ old('descripcion') }}</textarea>
                </div>
